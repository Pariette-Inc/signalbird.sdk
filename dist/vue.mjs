import { inject, ref, watch, getCurrentInstance, onScopeDispose } from 'vue';
...
function useSignalbird() {
  ...
  if (!client) {
    throw new Error("useSignalbird: app.use(signalbirdPlugin, { appKey }) \xE7a\u011Fr\u0131lmad\u0131.");
  }
  return client;
}
...
export { SIGNALBIRD_KEY, identify, registerDevice, signalbirdPlugin, useChat, useSignalbird };
