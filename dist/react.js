...
function SignalbirdProvider({ children, ...config }) {
  const client = react.useMemo(() => new SignalbirdApp(config), [config.publicKey, config.baseUrl, config.locale]);
  return react.createElement(AppContext.Provider, { value: client }, children);
}
...
exports.SignalbirdProvider = SignalbirdProvider;
exports.useChat = useChat;
exports.useIdentify = useIdentify;
exports.usePushRegistration = usePushRegistration;
